...
* O comando `pwd`  (*print working directory*) imprime o caminho ao diretório atual
...
As sequências devem ser descarregadas da plataforma da facility contratada e subidas ao servidor usando o software MobaXterm
