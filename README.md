...
O resultado será uma tabela com a classificação taxonômica por várias
abordagens.
...
Procure no catálogo e escolha *Annotate Genome/Assembly with RASTtk* e
insira na narrativa.
...
Em *Objects* estará o novo objeto criado *AssemblyAnnotation*, clicando
